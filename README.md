...
Originally designed as a replacement for a failed fanatec CSL pedals sensor that I couldn't find a spare for, now used in my own projects.
...
- **`GERBERS` folder**: Includes all production files, such as:
...
<img src="https://github.com/fabemit/Hall-Sensor/blob/main/images/fabemit_Logo.png" width="500" alt="fe-logo">
